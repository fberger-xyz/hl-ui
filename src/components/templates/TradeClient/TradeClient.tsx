...
import { TradeTemplate } from '@/components/templates/TradeTemplate/TradeTemplate'
import TradeTables from '@/components/features/trading/TradeTables/TradeTables'
import OrderbookAndTrades from '@/components/features/trading/OrderbookAndTrades/OrderbookAndTrades'
import TradePanel from '@/components/features/trading/TradePanel/TradePanel'
import TradingChart from '@/components/features/trading/TradingChart/TradingChart'
import TradePairSelector from '@/components/features/trading/TradePairSelector/TradePairSelector'
import TradePairKPIs from '@/components/features/trading/TradePairKPIs/TradePairKPIs'
import FavoriteMarkets from '@/components/features/trading/FavoriteMarkets/FavoriteMarkets'
