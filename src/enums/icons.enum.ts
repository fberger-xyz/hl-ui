...
export enum IconIds {
    ...
    STAR_FILLED = 'material-symbols:star-rounded',
    STAR_EMPTY = 'material-symbols:star-outline-rounded',
    EXTERNAL_LINK = 'carbon:launch',
    EDIT = 'carbon:edit',
    EXTERNAL_LINK_OUTLINE = 'cuida:open-in-new-tab-outline',
}
